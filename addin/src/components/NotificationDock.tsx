...
export default function NotificationDock() {
  ...
  return (
    <section
      className="shrink-0 border-t-2 border-accent/25 bg-gradient-to-b from-white to-bg px-4 py-3.5 shadow-[0_-8px_24px_rgba(11,15,26,0.18)]"
    ...
    >
      ...
      {notifications.length === 0 ? (
        <p className="text-[12px] text-ink-3">No messages yet.</p>
      ) : (
