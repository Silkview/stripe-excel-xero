...
export const MARKETING_PLANS: MarketingPlan[] = [
  {
    ...
    features: [
      { text: 'Pull any Stripe object to Excel' },
      { text: 'Up to 100 transactions per pull', bold: true },
      { text: 'Account_Mappings sheet' },
      { text: 'Build journal & bank tx rows' },
      { text: 'Xero push locked', dimmed: true },
      { text: 'Full transaction history', dimmed: true },
    ],
    featured: false,
