"use strict";(()=>{var e={};e.id=5536,e.ids=[5536],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},9539:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>y,patchFetch:()=>g,requestAsyncStorage:()=>p,routeModule:()=>f,serverHooks:()=>h,staticGenerationAsyncStorage:()=>m});var a={};n.r(a),n.d(a,{POST:()=>l});var r=n(3277),i=n(5265),o=n(5356),s=n(2946);async function c(e,t,n){let a=await (0,s.ud)(e);if(a?.account_id)return{accountId:a.account_id,created:!1};throw Error("ONBOARDING_REQUIRED")}var u=n(7993),d=n(8248);async function l(e){try{let{user:t}=await (0,u.Vc)(e),n=await e.json().catch(()=>({})),a="string"==typeof n.accountName?n.accountName:t.user_metadata?.account_name,r=await c(t.id,t.email??"",a);return(0,d.jsonSuccess)(r)}catch(t){if(t instanceof u.QR)return(0,d.bg)(t.code,t.message,t.status);let e=t instanceof Error?t.message:"Failed to provision account.";if("ONBOARDING_REQUIRED"===e)return(0,d.jsonSuccess)({accountId:"",created:!1,needsOnboarding:!0});return(0,d.bg)("PROVISION_ERROR",e,500)}}let f=new r.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/auth/ensure-account/route",pathname:"/api/auth/ensure-account",filename:"route",bundlePath:"app/api/auth/ensure-account/route"},resolvedPagePath:"/Users/ruvanfernando/stripe-excel-xero/web/app/api/auth/ensure-account/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:p,staticGenerationAsyncStorage:m,serverHooks:h}=f,y="/api/auth/ensure-account/route";function g(){return(0,o.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:m})}},7993:(e,t,n)=>{n.d(t,{QR:()=>s,Vc:()=>c,jm:()=>d,m6:()=>l,x1:()=>u});var a=n(8009),r=n(6140),i=n(438),o=n(2946);class s extends Error{constructor(e,t,n=401){super(t),this.code=e,this.status=n}}async function c(e){let t=e?function(e){let t=e.headers.get("authorization");return t?.startsWith("Bearer ")&&t.slice(7).trim()||null}(e):null;if(t){let e=(0,r.S)(),{data:n,error:i}=await e.auth.getUser(t);if(i||!n.user)throw new s("AUTH_REQUIRED","Please sign in to continue.",401);return{supabase:await (0,a.u)(),user:n.user}}let n=await (0,a.u)(),{data:{user:i},error:o}=await n.auth.getUser();if(o||!i)throw new s("AUTH_REQUIRED","Please sign in to continue.",401);return{supabase:n,user:i}}async function u(e){let{supabase:t,user:n}=await c(e),a=await (0,o.ud)(n.id);if(!a)throw new s("ACCOUNT_REQUIRED","No account found for this user.",403);if("member"===a.role)throw new s("FORBIDDEN","Only account owners and admins can access this resource.",403);return{supabase:t,user:n,membership:a}}async function d(e){let{supabase:t,user:n}=await c(e),a=e.headers.get("x-workspace-id")||e.headers.get("X-Workspace-Id")||"";if(!a)throw new s("WORKSPACE_REQUIRED","Select a workspace before connecting or pulling data.",400);let u=(0,r.S)(),d=await (0,o.ud)(n.id,u);if(!d)throw new s("ACCOUNT_REQUIRED","No account found for this user.",403);let{data:l}=await (0,i.v)(u).from("workspaces").select("id, account_id").eq("id",a).eq("account_id",d.account_id).maybeSingle();if(!l)throw new s("WORKSPACE_FORBIDDEN","Workspace not found or access denied.",403);if("member"===d.role){let{data:e}=await (0,i.v)(u).from("account_users").select("id").eq("user_id",n.id).eq("account_id",d.account_id).maybeSingle();if(!e?.id)throw new s("WORKSPACE_FORBIDDEN","You do not have access to this workspace.",403);let{data:t}=await (0,i.v)(u).from("account_user_workspaces").select("workspace_id").eq("account_user_id",e.id).eq("workspace_id",a).maybeSingle();if(!t)throw new s("WORKSPACE_FORBIDDEN","You do not have access to this workspace.",403)}return{supabase:t,user:n,workspaceId:a,accountId:d.account_id,role:d.role}}async function l(e){return(0,o.ud)(e)}},8248:(e,t,n)=>{n.d(t,{bg:()=>o,bx:()=>u,ds:()=>d,ff:()=>c,hd:()=>s,jsonSuccess:()=>i,tb:()=>r});var a=n(7076);let r=15e3;function i(e,t=200){return a.NextResponse.json({success:!0,data:e},{status:t})}function o(e,t,n=400,r){let i={success:!1,error:{code:e,message:t,...r}};return a.NextResponse.json(i,{status:n})}function s(e){let t=JSON.stringify(e).replace(/</g,"\\u003c"),n="object"==typeof e&&null!==e&&"status"in e&&String(e.status).includes("connected"),a="object"==typeof e&&null!==e&&"message"in e&&"string"==typeof e.message?e.message:null,r=function(e,t){if(t)return"Silkview Sync connected";let n="object"==typeof e&&null!==e&&"provider"in e&&"string"==typeof e.provider?e.provider.toLowerCase():"";return"xero"===n?"Xero not connected":"stripe"===n?"Stripe not connected":"Connection failed"}(e,n),i=n?"You can close this tab and return to Excel.":a??"Please close this tab and try again from the add-in.";return`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
</html>`}function c(e,t){return s({status:"error",provider:e,message:t})}function u(e,t){let n=JSON.stringify(t??"").replace(/</g,"\\u003c"),a=JSON.stringify({status:"signed_in",accessToken:e}).replace(/</g,"\\u003c"),r=JSON.stringify({status:"handoff_ready"}).replace(/</g,"\\u003c");return`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>Silkview Sync</title>
