"use strict";(()=>{var e={};e.id=5901,e.ids=[5901],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1317:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>h,patchFetch:()=>y,requestAsyncStorage:()=>d,routeModule:()=>l,serverHooks:()=>m,staticGenerationAsyncStorage:()=>p});var n={};i.r(n),i.d(n,{POST:()=>f});var r=i(3277),s=i(5265),a=i(5356),o=i(6140);async function c(e,t){let i=t.trim().toLowerCase(),n=1;for(let t=0;t<10;t++){let{data:t,error:r}=await e.auth.admin.listUsers({page:n,perPage:200});if(r||!t.users.length)break;let s=t.users.find(e=>e.email?.trim().toLowerCase()===i);if(s){let e=(s.identities??[]).map(e=>e.provider);return{userFound:!0,emailConfirmed:!!s.email_confirmed_at,hasEmailPasswordIdentity:e.includes("email")}}if(!t.nextPage)break;n=t.nextPage}return{userFound:!1,emailConfirmed:!1,hasEmailPasswordIdentity:!1}}var u=i(8248);async function f(e){let t=await e.json().catch(()=>({})),i="string"==typeof t.email?t.email.trim().toLowerCase():"";if(!i)return(0,u.bg)("VALIDATION_ERROR","email is required.",400);try{let e=(0,o.S)(),t=await c(e,i);return(0,u.jsonSuccess)(t)}catch(t){let e=t instanceof Error?t.message:"hint lookup failed";return(0,u.bg)("HINT_ERROR",e,500)}}let l=new r.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/auth/signin-hint/route",pathname:"/api/auth/signin-hint",filename:"route",bundlePath:"app/api/auth/signin-hint/route"},resolvedPagePath:"/Users/ruvanfernando/stripe-excel-xero/web/app/api/auth/signin-hint/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:d,staticGenerationAsyncStorage:p,serverHooks:m}=l,h="/api/auth/signin-hint/route";function y(){return(0,a.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:p})}},8248:(e,t,i)=>{i.d(t,{bg:()=>a,bx:()=>u,ds:()=>f,ff:()=>c,hd:()=>o,jsonSuccess:()=>s,tb:()=>r});var n=i(7076);let r=15e3;function s(e,t=200){return n.NextResponse.json({success:!0,data:e},{status:t})}function a(e,t,i=400,r){let s={success:!1,error:{code:e,message:t,...r}};return n.NextResponse.json(s,{status:i})}function o(e){let t=JSON.stringify(e).replace(/</g,"\\u003c"),i="object"==typeof e&&null!==e&&"status"in e&&String(e.status).includes("connected"),n="object"==typeof e&&null!==e&&"message"in e&&"string"==typeof e.message?e.message:null;return`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<p>${i?"You can close this tab and return to Excel.":n??"Please close this tab and try again from the add-in."}</p>
<script>
...
</html>`}function c(e,t){return o({status:"error",provider:e,message:t})}function u(e){let t=JSON.stringify({status:"signed_in",accessToken:e}).replace(/</g,"\\u003c"),i=JSON.stringify({status:"handoff_ready"}).replace(/</g,"\\u003c");return`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>Silkview Sync</title>
