"use strict";(()=>{var e={};e.id=5901,e.ids=[5901],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1317:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>h,patchFetch:()=>y,requestAsyncStorage:()=>p,routeModule:()=>l,serverHooks:()=>m,staticGenerationAsyncStorage:()=>d});var r={};i.r(r),i.d(r,{POST:()=>f});var s=i(3277),n=i(5265),a=i(5356),o=i(6140);async function c(e,t){let i=t.trim().toLowerCase(),r=1;for(let t=0;t<10;t++){let{data:t,error:s}=await e.auth.admin.listUsers({page:r,perPage:200});if(s||!t.users.length)break;let n=t.users.find(e=>e.email?.trim().toLowerCase()===i);if(n){let e=(n.identities??[]).map(e=>e.provider);return{userFound:!0,emailConfirmed:!!n.email_confirmed_at,hasEmailPasswordIdentity:e.includes("email")}}if(!t.nextPage)break;r=t.nextPage}return{userFound:!1,emailConfirmed:!1,hasEmailPasswordIdentity:!1}}var u=i(8248);async function f(e){let t=await e.json().catch(()=>({})),i="string"==typeof t.email?t.email.trim().toLowerCase():"";if(!i)return(0,u.bg)("VALIDATION_ERROR","email is required.",400);try{let e=(0,o.S)(),t=await c(e,i);return(0,u.jsonSuccess)(t)}catch(t){let e=t instanceof Error?t.message:"hint lookup failed";return(0,u.bg)("HINT_ERROR",e,500)}}let l=new s.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/auth/signin-hint/route",pathname:"/api/auth/signin-hint",filename:"route",bundlePath:"app/api/auth/signin-hint/route"},resolvedPagePath:"/Users/ruvanfernando/stripe-excel-xero/web/app/api/auth/signin-hint/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:p,staticGenerationAsyncStorage:d,serverHooks:m}=l,h="/api/auth/signin-hint/route";function y(){return(0,a.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:d})}},8248:(e,t,i)=>{i.d(t,{bg:()=>a,bx:()=>u,ds:()=>f,ff:()=>c,hd:()=>o,jsonSuccess:()=>n,tb:()=>s});var r=i(7076);let s=15e3;function n(e,t=200){return r.NextResponse.json({success:!0,data:e},{status:t})}function a(e,t,i=400,s){let n={success:!1,error:{code:e,message:t,...s}};return r.NextResponse.json(n,{status:i})}function o(e){let t=JSON.stringify(e).replace(/</g,"\\u003c"),i="object"==typeof e&&null!==e&&"status"in e&&String(e.status).includes("connected"),r="object"==typeof e&&null!==e&&"message"in e&&"string"==typeof e.message?e.message:null;return`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
