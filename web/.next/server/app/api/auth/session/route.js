"use strict";(()=>{var e={};e.id=7603,e.ids=[7603],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},4709:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>m,patchFetch:()=>h,requestAsyncStorage:()=>l,routeModule:()=>f,serverHooks:()=>d,staticGenerationAsyncStorage:()=>p});var n={};s.r(n),s.d(n,{POST:()=>u});var r=s(3277),i=s(5265),a=s(5356),o=s(8009),c=s(8248);async function u(e){let t=await e.json().catch(()=>({})),s="string"==typeof t.access_token?t.access_token:"",n="string"==typeof t.refresh_token?t.refresh_token:"";if(!s||!n)return(0,c.bg)("VALIDATION_ERROR","access_token and refresh_token are required.",400);let r=await (0,o.u)(),{error:i}=await r.auth.setSession({access_token:s,refresh_token:n});return i?(0,c.bg)("AUTH_ERROR",i.message,401):(0,c.jsonSuccess)({ok:!0})}let f=new r.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/auth/session/route",pathname:"/api/auth/session",filename:"route",bundlePath:"app/api/auth/session/route"},resolvedPagePath:"/Users/ruvanfernando/stripe-excel-xero/web/app/api/auth/session/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:l,staticGenerationAsyncStorage:p,serverHooks:d}=f,m="/api/auth/session/route";function h(){return(0,a.patchFetch)({serverHooks:d,staticGenerationAsyncStorage:p})}},8248:(e,t,s)=>{s.d(t,{bg:()=>a,bx:()=>u,ds:()=>f,ff:()=>c,hd:()=>o,jsonSuccess:()=>i,tb:()=>r});var n=s(7076);let r=15e3;function i(e,t=200){return n.NextResponse.json({success:!0,data:e},{status:t})}function a(e,t,s=400,r){let i={success:!1,error:{code:e,message:t,...r}};return n.NextResponse.json(i,{status:s})}function o(e){let t=JSON.stringify(e).replace(/</g,"\\u003c"),s="object"==typeof e&&null!==e&&"status"in e&&String(e.status).includes("connected"),n="object"==typeof e&&null!==e&&"message"in e&&"string"==typeof e.message?e.message:null;return`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
